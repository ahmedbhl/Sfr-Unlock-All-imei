...
<form id="check_imei" method="post" action="unlock_action.php" name="submit-form" >
IMEI<br><textarea name='imei' id="imei" rows="15" cols="20"></textarea><br><br>
<!--IMEI OF CONTRACT<br><input type="text" name='imei_ctr'><br><br>-->
<input type="submit" value="Unlock" id="send" class="enjoy-css" onClick="document.forms['submit-form'].submit();"><br><br>
</form>
